...
if mode == 'CNN':
	...
	concat_1 = concatenate([maxpool_1, maxpool_2], axis=2)
	...
	# ly_1 = Lambda(slice, arguments={'index1':0, 'index2':18})(input_layer)
	# ly_2 = Conv2D(32, (1, 3), activation='relu', padding='same', strides=3)(ly_1)
	# ly_3 = MaxPooling2D(pool_size=(1, 3))(ly_2)
	# ly_4 = Dropout(0.25)(ly_3)
	#
	# ly_5 = Lambda(slice, arguments={'index1':18, 'index2':32})(input_layer)
	# ly_6 = Conv2D(32, (1, 1), activation='relu', padding='same')(ly_5)
	# ly_6 = Dropout(0.25)(ly_6)
	#
	# ly_7 = concatenate([ly_4, ly_6])
	# ly_8 = Conv2D(32, (4, 1), activation='relu', padding='same')
	# ly_9 = Conv2D(32, (4, 1))
...
model.fit(x=train_x, y=train_y_1, epochs=100, shuffle=True, verbose=1)
